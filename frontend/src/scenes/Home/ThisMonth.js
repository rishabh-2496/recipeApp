...
import { getThisMonthRecipeStart, resetThisMonthRecipeState } from "./actions";
...
const mapStateToProps = (state) => ({
  recipeList: state.thisMonthRecipe.recipeList,
  dataFetching: state.thisMonthRecipe.dataFetching,
  failureMessage: state.thisMonthRecipe.failureMessage,
});

const mapDispatchToProps = { getThisMonthRecipeStart };
